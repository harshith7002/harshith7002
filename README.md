...
CSE student at SRM University, Hyderabad. I build full-stack apps and spend most of my side-project time wiring LLM APIs into things that actually work end to end, not just a chat box on top of a prompt.

**What I use regularly:** Python (Flask, FastAPI), Node/Express, React, TypeScript, some Java and basic Spring Boot. For AI work: Groq, Gemini, and Claude APIs, and I've been building around the MCP tool-calling pattern. PostgreSQL/MongoDB for storage.
...
More on my [portfolio](https://portfolio-saiharshith.netlify.app/) · [LinkedIn](https://www.linkedin.com/in/sai-harshith-moluguri-892679324/)
